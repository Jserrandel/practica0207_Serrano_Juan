...
#  con los nombres y los teléfonos de los clientes de una
#  empresa. El programa debe  incorporar funciones para crear
#  el fichero con el listín si no existe, para consultar el
#  teléfono de un cliente, añadir el teléfono de un nuevo
#  cliente y eliminar el teléfono de un cliente. El listín 
# debe estar guardado en el fichero de texto listin.txt
